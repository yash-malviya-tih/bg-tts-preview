...
function App() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 py-4 md:px-6 md:py-5 relative overflow-hidden bg-[color:rgb(var(--brand-bg))]">
      ...
      {/* Main Container */}
      <div className="w-full max-w-[1020px] 2xl:max-w-[1180px] flex flex-col gap-3 2xl:gap-4 z-10">
        ...
        <div className="flex items-center gap-3 pl-1">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Type text, pick or clone a voice, and hear it speak — in 12 Indian languages.
              </p>
            </div>
        </div>
